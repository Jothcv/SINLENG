    ...
    preguntas: [
        {
            ...
            opciones: ["mama", "tio", "maestra"],
            correcta: 1,//tio
            videoURL: "/tio.mp4"
        },
        {
            pregunta: "Qué es esta haciendo en el video ",
            opciones: ["tia", "maestra", "rrapido"],
            correcta: 1,//maestra
            videoURL: "/maestra.mp4"
        },
        {
            pregunta: "Qué es esta haciendo en el video",
            opciones: ["hijo", "papa", "buenos dias"],
            correcta: 0,//hijo
            videoURL: "/hijo.mp4"
        },
        {
            pregunta: "Qué es esta haciendo en el video",
            opciones: [ "rrapido", "no gracias","mama"],
            correcta: 2,//mama
            videoURL:"/mama.mp4"
        },
        {
            pregunta: "Qué es esta haciendo en el video",
            opciones: ["tio", "papa", "prima"],
            correcta: 2,//prima
            videoURL: "/prima.mp4"
        }
    ]
